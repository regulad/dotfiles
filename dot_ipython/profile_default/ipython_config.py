...
#  Default: None
# c.InteractiveShellApp.gui = "gtk4"
...
# c.InteractiveShell.banner1 = "Python 3.12.3 (main, Jan  8 2026, 11:30:50) [GCC 13.3.0]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.9.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
c.InteractiveShell.logfile = (
    f"~/.ipython/logs/session_{time.strftime('%Y%m%d_%H%M%S')}.log"
)
...
# c.TerminalInteractiveShell.banner1 = "Python 3.12.3 (main, Jan  8 2026, 11:30:50) [GCC 13.3.0]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.9.0 -- An enhanced Interactive Python. Type '?' for help.\n"
